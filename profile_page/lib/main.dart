...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ...
            // 5. Drawer item Pengaturan dengan AlertDialog
            ListTile(
              ...
              onTap: () {
                ...
                showDialog(
                  ...
                  builder: (context) => AlertDialog(
                    title: const Text('Pengaturan'),
                    content: const Text('Ini adalah placeholder menu pengaturan. Fitur belum tersedia.'),
                    actions: [
                      TextButton(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  const CircleAvatar(
                    ...
                    backgroundImage: NetworkImage(
                      'https://avatars.githubusercontent.com/malhikuna',
                    ),
                  ),
            ...
            const Row(
              children: [
                Expanded(child: _StatBox(label: 'Post', value: '180')),
                Expanded(child: _StatBox(label: 'Teman', value: '10')),
                Expanded(child: _StatBox(label: 'Like', value: '800K')),
              ],
            ),
            const SizedBox(height: 24),
            // === SECTION CARD ===
            ...
            const _SectionCard(
              icon: Icons.school,
              title: 'Pendidikan',
              content: 'Universitas Universitas — Semester 6\nIPK: 4',
            ),
            const _SectionCard(
              icon: Icons.favorite,
              title: 'Hobi & Minat',
            ...
            const _SectionCard(
              icon: Icons.email,
              title: 'Kontak',
              content: 'hikmal767@gmail.com\n+62 851-5681-8587',
            ),
            const _SectionCard(
              icon: Icons.star,
              title: 'Skilss',
              content: 'Makan • Tidur • Rebahan • Scrolling • Metime',
            ),
      ...
      // 6. Mengganti menjadi NavigationBar (Material 3)
